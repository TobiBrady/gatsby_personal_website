...
export default function Sidebar() {
    ...
    return (
        <div className="lg:w-2/5 lg:h-screen lg:sticky lg:top-0 flex flex-col" >
            ...
            <div className="bg-center bg-cover m-10 md:mx-20 my-5 lg:my-7 lg:ml-7 lg:mr-0 lg:h-screen h-96 desktop-image">
                <img src={ me } alt="Tobi with a lemur" className="hidden" />
            </div>
